...
--
-- Dumping data for table `tblbugreport`
--

LOCK TABLES `tblbugreport` WRITE;
/*!40000 ALTER TABLE `tblbugreport` DISABLE KEYS */;
/*!40000 ALTER TABLE `tblbugreport` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tblrfwallet` VALUES (1,0.00,'OPEN');
...
INSERT INTO `tblversion` VALUES (1,'version 1.1.2 build 71621','Includes new features, enhancements and bug fixes','- Implemented a revolving fund,- User can input company details,- Report Header and Form Banner details are came from database','- Fixed update and delete feature, - Fixed report for journal entry is not balanced, - Fixed description free input');
...
-- Dump completed on 2021-07-17 10:19:22
