...
public class FrameModifyVATType extends javax.swing.JFrame {

    String type;

    public FrameModifyVATType() {
        initComponents();
        setIconImage();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ("DV".equals(type)) {
            ...
            FrameReceiptVoucher.ModifyVATType(cbtype.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameModifyVATType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FrameModifyVATType().setVisible(true);
        });
    }
